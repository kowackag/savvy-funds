...
export const AuthLayout = () => {
	return (
		<div className="relative flex min-h-full justify-center p-6 sm:items-center sm:bg-neutral20 sm:px-0">
			...
			<div className="xl:auth-layout w-full max-w-2xl lg:max-w-screen-2xl lg:p-6 xl:py-24 xl:pl-32 xl:pr-44">
